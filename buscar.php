...
if (isset($_GET['criterio']) && isset($_GET['valor'])) {
    ...
    if (!in_array($criterio, $criteriosValidos)) {
        header('Location: buscar.html'); //Ahora si la consulta es nula simplemente lo devuelve
    ...
    <section class="u-align-left u-clearfix u-container-align-left u-image u-shading" id="sec-68e1" data-image-width="1980" data-image-height="1400">
        <div class="u-clearfix u-sheet u-sheet-1">
            <div class="container mt-5">
                <h1 class="text-center">Músicos Registrados</h1>
                <div class="row">
        ...
        <div class="col-md-4 col-lg-3 mb-4">
            <div class="card user-info-left">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="contact">
                        <a href="https://wa.me/<?php echo $row['celular'];?>" class="btn btn-block btn-danger mb-2"><i class="fa fa-envelope-o"></i>Conectar</a>
                        <a href="perfil/index.php?id=<?php echo $row['idusuarios'];?>" class="btn btn-block btn-success"><i class="fa fa-book"></i>Ver perfil</a>
                    </div>
                </div>
            </div>
        </div>
