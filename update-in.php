        ...
        <div class="row">
            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-right">Update</h4>
                    </div>
                    <form action="procesos/us-process.php" method="POST" enctype="multipart/form-data">
                        <div class="row mt-2">
                            <div class="col-md-6"><label class="labels">Artistic name</label><input type="text" class="form-control" value="<?php echo $row['nombre_artistico']; ?>" name="nombre_artistico"></div>
                            <div class="col-md-6"><label class="labels">Real name</label><input type="text" class="form-control" value="<?php echo $row['nombre_completo']; ?>" name="nombre_completo"></div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-12"><label class="labels">Email</label><input type="email" class="form-control" value="<?php echo $row['correo']; ?>" name="correo_electronico"></div>
                            <div class="col-md-12"><label class="labels">Location</label><input type="text" class="form-control" value="<?php echo $row['ubicacion']; ?>" name="ubicacion"></div>
                            <div class="col-md-12"><label class="labels">Phone number</label><input type="text" class="form-control" value="<?php echo $row['celular']; ?>" name="numero_celular"></div>
                            <div class="col-md-12"><label class="labels">Instrument(s)</label><input type="text" class="form-control" value="<?php echo $row['instrumentos']; ?>" name="instrumentos"></div>
                            <div class="col-md-12"><label class="labels">Gender(s)</label><input type="text" class="form-control" value="<?php echo $row['genero']; ?>" name="generos_musicales"></div>
                            <div class="col-md-12"><label class="labels">Biography</label><input type="text" class="form-control" value="<?php echo $row['biografia']; ?>" name="biografia"></div>
                            <div class="col-md-12"><label class="labels">Link</label><input type="text" class="form-control" value="<?php echo $row['enlace']; ?>" name="redes_sociales"></div>
                            <div class="col-md-12"><label class="labels">Profile picture (PNG, JPG, JPEG)</label></div>
                        ...
                        <label class="form-check-label" for="terminos">Accept the changes</label></div>
            ...
            <div class="col-md-4">
                <div class="p-3 py-5">
                    ...
                    <div class="col-md-12"><label class="labels">Image</label><div><input type="file" class="form-control-file"></div></div>
                </div>
            </div>
        </div>
        <?php
